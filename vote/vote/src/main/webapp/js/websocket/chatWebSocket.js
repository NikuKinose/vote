...
function loadChatData() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            console.log(data);
            $("#whole1").html("");
            $.each(data.data, function (i, item) { //data.data后台传过来的值，i第几次循环，item当前循环变量
                //评论数
                ...
                $("#whole1").append(//加html代码
                    ...
                    "            <div id=\"scheme\" style=\"border: solid #09299a 1.5px;border-radius: 5px;width: 100%;height: auto;padding: 12px\">\n" +
                    "\n" +
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var addhtml = "<div style=\"margin-left: "+space+"px;\">\n" +
                    ...
                    "                        <br />\n" +
                    "                        <div style=\"float: left;color:#09299a;text-align: center;\">&nbsp;"+selectUser(_data.speakId,_data.speakSchemeId)+"&nbsp;回复&nbsp;"+selectUser(_data.speakFatherId,_data.speakSchemeId)+":</div>\n" +
                    "\n" +
                    "                        <div>" +
                ...
                //时间序列发言websocket
                var addhtml2 = "<div style=\"color:#09299a;\">\n" +
