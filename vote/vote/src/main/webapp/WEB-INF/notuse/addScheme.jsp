        ...
        <div class="row topNav">
            <div class="col-md-9 col-xs-12">
                <div class="row" id="row"><div class="col-md-offset-1 col-md-2 col-xs-4 ">
                    <!--设置研讨时间按钮-->
                    <div class="rect rightMenu" id="rect2" style="background: #2c87f7;">
                        <h5 style="font-family: &#39;Adobe Garamond Pro Bold&#39;;color: white;padding-top:13px;text-align: center">添加备选方案</h5>
                    </div>
                    <div class="recta" id="recta2" style="border-left: 12px solid #2c87f7;">
                    </div>
                    <div style="margin-left: 10px;margin-top: -29px">
                    </div>
                </div><div class="col-md-2 col-xs-4  ">
                    <div class="rect rightMenu" style="background: darkgray;" id="rect3">
                        <h5 style="font-family: &#39;Adobe Garamond Pro Bold&#39;;color:white;padding-top:13px;text-align: center">投票规则设置</h5>
                    </div>
                    <div class="recta" id="recta3" style="border-left:14px solid darkgray">
                    </div>
                    <div style="margin-left: 10px;margin-top: -29px">
                    </div>
                </div><div class="col-md-2 col-xs-4  ">
                    <div class="rect rightMenu" style="background: darkgrey" id="rect12">
                        <h5 style="font-family: &#39;Adobe Garamond Pro Bold&#39;;color:white;padding-top:13px;text-align: center">专家进行决策</h5>
                    </div>
    ...
    <div class="container-fluid" style="padding: 0">
        ...
        <div class="col-lg-6 col-xs-12" style="width:59%;">
            ...
            <div class="public-page">
               ...
               <iframe class="embed-responsive-item ww" name="pp" src="../../content/expertShowDiscussProcess.jsp" id="iframepage" style=""></iframe>
